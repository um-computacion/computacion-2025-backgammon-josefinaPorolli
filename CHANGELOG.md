...
- Fixed pylint errors and cli test as it showed unwanted messages

## [2.0.9] - 29/10/25

### Changed

- Developed JUSTIFICACION.md file.

## [2.0.8] - 28/10/25

### Changed

- Modified Board in order to fulfill open/closed principle. Each type of field is now divided and other types of fields can be made without changing the whole code.
